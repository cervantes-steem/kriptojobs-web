...
<footer>
	<div class="row lg-menu">
		<div class="container">	
			<div class="row">	
				<div class="col-sm-4 col-md-4"> <img src="images/logokriptojobs.png" class="img-responsive" style="height: 90px">
	...
	<div class="row md-menu">
		<div class="container">
			<div class="row">
				<div class="col-md-4"> 
					<h3> Sobre KriptoJobs</h3>
					<p>Sed Ut Perspiciatis Unde Omnis Iste Natus Error Sit Voluptatem.</p>
					<p>7860 North Park Place San Francisco, CA 94120</p>
	...
	<div class="row copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p> Todos los derechos reservados para KriptoJobs.</p>
				</div>
			</div>
		</div>
	</div>
